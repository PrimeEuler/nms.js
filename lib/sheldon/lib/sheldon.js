...
function sheldon(STDIN,STDOUT){
            ...
            vty.on('line',function(line){
                ...
                varBind = shell.cli.auth.access 
                        ? varBind 
                        : shell.auth;
                shell.cli._eval(varBind, args, line);
            })
            shell.auth = function(username,password){
                shell.cli.auth.user = username;
                shell.cli.auth.access = true;
                return shell.cli.auth
